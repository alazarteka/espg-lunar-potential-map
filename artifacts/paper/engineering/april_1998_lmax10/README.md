# April 1998 Engineering Analysis (lmax=10)

## Generation Command

```bash
uv run python -m src.engineering \
  artifacts/paper/harmonics/april_1998_lmax10.npz \
  --output-dir artifacts/paper/engineering/april_1998_lmax10 \
  -v
```

## Input

- **Harmonics file**: `artifacts/paper/harmonics/april_1998_lmax10.npz`
- **lmax**: 10
