"""Optional PyTorch loss-cone APIs.

The canonical implementation lives under `src.losscone.torch.*`.

For backward compatibility with older import paths, `src.model_torch` re-exports
this module.
"""
...
def _torch_required(*_args: Any, **_kwargs: Any) -> Any:
    raise ImportError("PyTorch is required for `src.losscone_torch`.")
